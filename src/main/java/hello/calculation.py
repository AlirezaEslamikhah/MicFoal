...
# Load the CSV file
# csv_file = 'Entry10-s1.csv'
# csv_file = 'output_s1_copy.csv'
csv_file = 'output_s4_copy.csv'
...
for i in range(num_classes):
    ...
    print(f"Class {i}: Precision={precision:.9f}, Recall={recall:.9f}")
...
# Display the result
print("AvF0.5\t\tAvF1\t\tAvF1.5\t\tCBA\t\tmGM\t\tAVCC")
print(f"{avg_f_beta_values[0.5]:.9f}\t{avg_f_beta_values[1]:.9f}\t{avg_f_beta_values[1.5]:.9f}\t{average_CBA:.9f}\t{mGM:.9f}\t{AVCC:.9f}")
